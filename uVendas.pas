...
uses
  ...
  Vcl.Grids, Vcl.DBGrids, Data.FMTBcd, Data.DbxSqlite, Data.SqlExpr,
  Datasnap.DBClient, Vcl.ExtCtrls, Vcl.DBCtrls, Datasnap.Provider;
...
begin
  ...
  cDS_Carrinho.Fieldbyname('vlrTotal').AsFloat := cDS_Produtos.Fieldbyname('vlrTotal').AsFloat * cDS_Carrinho.Fieldbyname('qtde').AsFloat;
  cDS_Carrinho.Post;
...
begin
  ...
  TesteConnection.Params.Text := 'Database='+vsCaminho+'teste.db';
  try
